...
# brc1_aba_treatment = select(aba_results$merged_tests, c(Geneid, logCPM_brc1_aba_vs_brc1_ctr,logFC_brc1_aba_vs_brc1_ctr)) %>% filter(Geneid %in% aba_responding_genes$Geneid)
# 
# ggplot(brc1_aba_treatment, aes(x= logCPM_brc1_aba_vs_brc1_ctr, y=logFC_brc1_aba_vs_brc1_ctr ))+
#   geom_point()
...
# 
example = batch_enrichedheatmaps(test2, 
                                 tss = tss, 
                                 anno_color = "black", 
