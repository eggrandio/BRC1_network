...
# Format input data for GO and GSEA analyses
...
genes_up = GO_input %>% filter(get(fc_column) > 0)
genes_dn = GO_input %>% filter(get(fc_column) < 0)

GOenrich_up = enrichGO(gene = genes_up,
...
GOenrich_dn = enrichGO(gene = genes_dn,
                OrgDb = org.At.tair.db,
                keyType = "TAIR",
                ont = "BP",
                pAdjustMethod = "BH",
