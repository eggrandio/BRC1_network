...
# ABA-responding genes from Nemhauser et al., 2006 - doi: 10.1016/j.cell.2006.05.050
ABA_genes_nemhauser = fread("./input/ABA-responding_genes_Nemhauser2006.txt") %>% mutate(gene_id = toupper(gene_id))

# BRC1-dep ABA-responding genes from Gonzalez-Grandio et al., 2017 - oi.org/10.1073/pnas.1613199114
...
### TO DO: Check igraph tutorial (https://kateto.net/networks-r-igraph) and build "test" network
# Use 26 ABA core + BRC1, and add direct target info
