...
GO_input = filtered_tests_output %>% dplyr::select(Geneid, logFC_GFP_BRC1ind_vs_brc1)

GO_up = GO_input %>% filter(get(colnames(GO_input[2])) > 0)

GOenrich_up = enrichGO(gene = GO_up,
